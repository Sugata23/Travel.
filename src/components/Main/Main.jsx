...
const Data = [
  {
    ...
    fees: "$700",
    description:
      "The epitome of romance, Bora Bora is one of the best travel destinations in the World. This place is known for its luxurious stays and adventures activities.",
  },
  ...
  return (
    <section className="main container section">
      ...
      <div className="secContent grid">
        {Data.map(
          ({ id, imgSrc, title, location, grade, fees, description }) => {
            return (
